...
Builder.prototype.getUk25 = function() {
    ...
    if (this.version.startsWith('0.51')) magic = "-8832040574896607694";
    else if (this.version.startsWith('0.53')) magic = "-76506539888958491";
    else if (this.version.startsWith('0.55')) magic = "-9156899491064153954";
    else if (this.version.startsWith('0.57')) magic = "-816976800928766045";
    else throw new Error('Unhandled config version: ' + this.version);
    return longjs.fromString(magic, false);
};
